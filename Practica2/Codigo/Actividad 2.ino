...
const char* ssid = "rigo";
const char* password = "rigo12345";
...
if (req.indexOf("on2") != -1) {digitalWrite(LED_EXT, HIGH);
estado = "Encendido";}
if (req.indexOf("off2") != -1){digitalWrite(LED_EXT, LOW);
estado = "Apagado";}
//////////////////////////////////////////////
// Página WEB. ////////////////////////////
...
client.println("<h1>Rigoberto Vazquez Jose Cota</h1>");
